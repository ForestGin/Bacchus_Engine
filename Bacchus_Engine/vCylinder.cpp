...
// ctor
///////////////////////////////////////////////////////////////////////////////
vCylinder::vCylinder(float baseRadius, float topRadius, float height, int sectors,
...
// setters
///////////////////////////////////////////////////////////////////////////////
void vCylinder::set(float baseRadius, float topRadius, float height, int sectors,
...
// print itself
///////////////////////////////////////////////////////////////////////////////
void vCylinder::printSelf() const
{
    std::cout << "===== Cylinder =====\n"
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::drawLines(const float lineColor[4]) const
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void vCylinder::drawWithLines(const float lineColor[4]) const
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::buildVerticesSmooth()
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::buildVerticesFlat()
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::buildUnitCircleVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void vCylinder::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> vCylinder::getSideNormals()
{
    const float PI = acos(-1);
    float sectorStep = 2 * PI / sectorCount;
    float sectorAngle;  // radian
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> vCylinder::computeFaceNormal(float x1, float y1, float z1,  // v1
