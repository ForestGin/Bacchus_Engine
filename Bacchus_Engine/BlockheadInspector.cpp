...
inline void BlockheadInspector::CreateGameObjectNode(GameObject& Selected) const
{
...
inline void BlockheadInspector::CreateMeshNode(GameObject& Selected) const
{
...
inline void BlockheadInspector::CreateRendererNode(GameObject& Selected) const
{
...
inline void BlockheadInspector::CreateMaterialNode(GameObject& Selected) const
{
...
inline void BlockheadInspector::CreateCameraNode(GameObject& Selected) const
{
	if (Startup)
		ImGui::SetNextItemOpen(true);
