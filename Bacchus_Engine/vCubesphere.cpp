...
///////////////////////////////////////////////////////////////////////////////
vCubesphere::vCubesphere(float radius, int sub, bool smooth) : radius(radius), subdivision(sub), smooth(smooth), interleavedStride(32)
{
...
// setters
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::setRadius(float radius)
{
    this->radius = radius;
    updateRadius(); // update vertex positions only
}

void vCubesphere::setSideLength(float side)
{
    float radius = side * sqrt(3.0f) / 2;   // convert side length to radius
    setRadius(radius);
}

void vCubesphere::setSubdivision(int iteration)
{
...
void vCubesphere::setSmooth(bool smooth)
{
...
// print itself
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::printSelf() const
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::drawLines(const float lineColor[4]) const
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::drawWithLines(const float lineColor[4]) const
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::drawFace(int faceId) const
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::buildVerticesFlat()
{
    // generate unit-length verties in +X face
    std::vector<float> unitVertices = vCubesphere::getUnitPositiveX(vertexCountPerRow);
    ...
    for (unsigned int i = 0; i < vertexCountPerRow - 1; ++i)
    {
        ...
        for (unsigned int j = 0; j < vertexCountPerRow - 1; ++j, ++k1, ++k2)
        {
            ...
            vCubesphere::scaleVertex(v1, radius);
            vCubesphere::scaleVertex(v2, radius);
            vCubesphere::scaleVertex(v3, radius);
            vCubesphere::scaleVertex(v4, radius);
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::buildVerticesSmooth()
{
    // generate unit-length verties in +X face
    std::vector<float> unitVertices = vCubesphere::getUnitPositiveX(vertexCountPerRow);
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addVertices(const float v1[3], const float v2[3], const float v3[3], const float v4[3])
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addNormals(const float n1[3], const float n2[3], const float n3[3], const float n4[3])
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addTexCoords(const float t1[2], const float t2[2], const float t3[2], const float t4[2])
{
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
const float* vCubesphere::getVerticesForFace(int faceId) const
{
...
const float* vCubesphere::getNormalsForFace(int faceId) const
{
    if(faceId >= 0 && faceId <= 5)
    {
...
const float* vCubesphere::getTexCoordsForFace(int faceId) const
{
    if(faceId >= 0 && faceId <= 5)
    {
...
const float* vCubesphere::getInterleavedVerticesForFace(int faceId) const
{
    if(faceId >= 0 && faceId <= 5)
    {
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::computeFaceNormal(const float v1[3], const float v2[3], const float v3[3], float n[3])
{
...
///////////////////////////////////////////////////////////////////////////////
float vCubesphere::computeScaleForLength(const float v[3], float length)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> vCubesphere::getUnitPositiveX(unsigned int pointsPerRow)
{
    ...
    for(unsigned int i = 0; i < pointsPerRow; ++i)
    {
        ...
        for(unsigned int j = 0; j < pointsPerRow; ++j)
        {
            ...
            scale = vCubesphere::computeScaleForLength(v, 1);
            v[0] *= scale;
            v[1] *= scale;
            v[2] *= scale;
...
///////////////////////////////////////////////////////////////////////////////
void vCubesphere::scaleVertex(float v[3], float scale)
{
    v[0] *= scale;
    v[1] *= scale;
    v[2] *= scale;
