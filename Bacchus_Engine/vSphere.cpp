...
// ctor
///////////////////////////////////////////////////////////////////////////////
vSphere::vSphere(float radius, int sectors, int stacks, bool smooth) : interleavedStride(32)
{
...
// setters
///////////////////////////////////////////////////////////////////////////////
void vSphere::set(float radius, int sectors, int stacks, bool smooth)
{
    this->radius = radius;
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::drawLines(const float lineColor[4]) const
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void vSphere::drawWithLines(const float lineColor[4]) const
{
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::buildVerticesSmooth()
{
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::buildVerticesFlat()
{
    const float PI = acos(-1);
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void vSphere::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> vSphere::computeFaceNormal(float x1, float y1, float z1,  // v1
