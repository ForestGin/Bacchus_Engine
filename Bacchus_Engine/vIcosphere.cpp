...
// ctor
///////////////////////////////////////////////////////////////////////////////
vIcosphere::vIcosphere(float radius, int sub, bool smooth) : radius(radius), subdivision(sub), smooth(smooth), interleavedStride(32)
{
    if(smooth)
        buildVerticesSmooth();
    else
...
// setters
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::setRadius(float radius)
{
    this->radius = radius;
    updateRadius(); // update vertex positions only
}

void vIcosphere::setSubdivision(int iteration)
{
...
void vIcosphere::setSmooth(bool smooth)
{
...
// print itself
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::printSelf() const
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::drawLines(const float lineColor[4]) const
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::drawWithLines(const float lineColor[4]) const
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> vIcosphere::computeIcosahedronVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::buildVerticesFlat()
{
    ...
    for(int i = 1; i <= 5; ++i)
    {
        ...
        vIcosphere::computeFaceNormal(v0, v1, v2, n);
        ...
        vIcosphere::computeFaceNormal(v1, v3, v2, n);
        addVertices(v1, v3, v2);
        addNormals(n, n, n);
        addTexCoords(t1, t3, t2);
        addIndices(index+3, index+4, index+5);

        vIcosphere::computeFaceNormal(v2, v3, v4, n);
        ...
        vIcosphere::computeFaceNormal(v3, v11, v4, n);
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::buildVerticesSmooth()
{
    //const float S_STEP = 1 / 11.0f;         // horizontal texture step
    //const float T_STEP = 1 / 3.0f;          // vertical texture step
    const float S_STEP = 186 / 2048.0f;     // horizontal texture step
    ...
    vIcosphere::computeVertexNormal(v, n);
    ...
    scale = vIcosphere::computeScaleForLength(v, 1);
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::subdivideVerticesFlat()
{
...
//        newV2         //
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::subdivideVerticesSmooth()
{
    std::vector<unsigned int> tmpIndices;
    int indexCount;
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addVertices(const float v1[3], const float v2[3], const float v3[3])
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addNormals(const float n1[3], const float n2[3], const float n3[3])
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addTexCoords(const float t1[2], const float t2[2], const float t3[2])
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::addSubLineIndices(unsigned int i1,
                                  unsigned int i2,
                                  unsigned int i3,
                                  unsigned int i4,
                                  unsigned int i5,
...
///////////////////////////////////////////////////////////////////////////////
unsigned int vIcosphere::addSubVertexAttribs(const float v[3], const float n[3], const float t[2])
{
    unsigned int index;     // return value;

    // check if is shared vertex or not first
    if(vIcosphere::isSharedTexCoord(t))
    {
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::computeFaceNormal(const float v1[3], const float v2[3], const float v3[3], float n[3])
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::computeVertexNormal(const float v[3], float normal[3])
{
    // normalize
    float scale = vIcosphere::computeScaleForLength(v, 1);
    normal[0] = v[0] * scale;
    normal[1] = v[1] * scale;
    normal[2] = v[2] * scale;
}
...
///////////////////////////////////////////////////////////////////////////////
float vIcosphere::computeScaleForLength(const float v[3], float length)
{
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::computeHalfVertex(const float v1[3], const float v2[3], float length, float newV[3])
{
    newV[0] = v1[0] + v2[0];
    newV[1] = v1[1] + v2[1];
    newV[2] = v1[2] + v2[2];
    float scale = vIcosphere::computeScaleForLength(newV, length);
    newV[0] *= scale;
    newV[1] *= scale;
    newV[2] *= scale;
}
...
///////////////////////////////////////////////////////////////////////////////
void vIcosphere::computeHalfTexCoord(const float t1[2], const float t2[2], float newT[2])
{
...
//      15  16  17  18  19      //
///////////////////////////////////////////////////////////////////////////////
bool vIcosphere::isSharedTexCoord(const float t[2])
{
    ...
    {
        if(vIcosphere::isOnLineSegment(&segments[i], &segments[j], t))
...
///////////////////////////////////////////////////////////////////////////////
bool vIcosphere::isOnLineSegment(const float a[2], const float b[2], const float c[2])
{
